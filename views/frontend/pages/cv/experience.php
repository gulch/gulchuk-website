<div class="ui header">
    <i class="icon">
        <svg class="gi-icon">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#experience"></use>
        </svg>
    </i>
    <div class="content">
        Experience
    ...
    <div class="ui item">
        <div class="content">
            ...
            <div class="description">
                <p>
                    Full development cycle: design, frontend, backend, api, seo, email campaigns configure
                    etc.
                    <br>
                    Technologies/frameworks: PHP, Laravel 5, Semantic UI, Javascript, jQuery, Redis,
                    MySQL/MariaDB.
                </p>
