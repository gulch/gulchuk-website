<div class="ui header">
    <i class="icon">
        <svg class="gi-icon">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#diploma"></use>
        </svg>
    </i>
    <div class="content">
        Education
...
<ul>
    <li>
        <a href="https://www.udemy.com/certificate/UC-7HF8GR2L/"
           target="_blank"
           rel="nofollow noopener"
        >
    ...
    <li>
        <a href="https://www.englishdom.com/cn/fe6de3bc/"
           target="_blank"
           rel="nofollow noopener"
        >
