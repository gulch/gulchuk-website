<div class="ui header">
    <i class="icon">
        <svg class="gi-icon">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#skills"></use>
        </svg>
    </i>
    <div class="content">
        Skills
...
<p>
    ...
    <br>
    <strong>English language</strong> — Elementary
</p>
...
<ul>
    ...
    <li>
        PHP optimization: tuning configuration, Opcache, XCache, profiling;
    </li>
    <li>
