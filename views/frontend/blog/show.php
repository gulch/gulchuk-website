    ...
    <div class="main-container">
        ...
        <div class="ui stackable grid">
            <div class="twelve wide column" itemscope="" itemtype="http://schema.org/Article">
                ...
                <div class="ui breadcrumb unimportant-text" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                    <a href="/" class="section" itemprop="url">
                        Home
                ...
                <meta itemscope itemprop="mainEntityOfPage" itemType="http://schema.org/WebPage" itemid="<?= config('app_url') ?>/blog/<?= $article->slug ?>" />
