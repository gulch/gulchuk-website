...
<div class="ui warning large form segment">
    <form method="POST" action="/<?= config('backend_segment') ?>/articles/save" accept-charset="UTF-8">
        ...
        <input type="hidden" id="redirect_url" value="<?= $redirectUrl ?? '/'.config('backend_segment').'/articles' ?>">
        ...
        <div class="ui field">
            ...
            <textarea name="content" id="content" class="wysiwyg-editor" cols="30" rows="10"><?= isset($article) ? $this->e($article->content) : '' ?></textarea>
        </div>
